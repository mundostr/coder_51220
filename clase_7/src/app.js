...
server.post('/usuario', async (req, res) =>{
    ...
    */
    ...
    const bodyOk = CAMPOS_REQUERIDOS.every(campo => Object.prototype.hasOwnProperty.call(req.body, campo) && req.body[campo] !== null );
    const mensaje = bodyOk ? 'Todos los campos correctos' : 'Faltan campos en la solicitud';
    res.status(200).send({ mensaje: mensaje, body: req.body });
})
