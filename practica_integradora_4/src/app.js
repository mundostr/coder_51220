...
// Como alternativa a Multer, podemos utilizar también express-fileupload
// que cuenta con una sintaxis muy sencilla
import fileUpload from 'express-fileupload';
// Importamos logger.service.js, donde habilitamos un par de servicios para registro (ver archivo)
import { loggerService } from './services/logger.service.js'
import swaggerUi  from 'swagger-ui-express';
import swaggerUserDocument from './docs/swagger.user.config.json' assert { type: 'json' };
...
// Más info Swagger: https://www.npmjs.com/package/swagger-ui-express
app.use('/userdocs', swaggerUi.serve, swaggerUi.setup(swaggerUserDocument));
