...
// Podemos tener una simple constante en nuestro config, para decidir si iniciar en modo de desarrollo o producción
// const mode = 'DEVELOPMENT';

// Cambio de etapa desde cl
// Por supuesto, como vimos, también podemos aprovechar la comodidad de commander para parsear argumentos de
// línea de comandos y utilizarlos para ajuste de configuraciones
...
dotenv.config({ path: cl_options.mode == 'DEVELOPMENT' ? './.env.development': './.env.production' });
